...
{/* TODO: see all the comments and uncomment images */}
...
{/* [![npm](https://img.shields.io/npm/v/@reatom/react-v2?style=flat-square)](https://www.npmjs.com/packages/@reatom/react-v2) */}
...
<Tabs groupId="package-manager" items={['npm', 'yarn', 'pnpm', 'bun']} persist>
  <Tab value="npm">
    ```bash
    npm install @reatom/react-v2 @reatom/core-v2 react
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @reatom/react-v2 @reatom/core-v2 react
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @reatom/react-v2 @reatom/core-v2 react
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @reatom/react-v2 @reatom/core-v2 react
    ```
  </Tab>
</Tabs>
