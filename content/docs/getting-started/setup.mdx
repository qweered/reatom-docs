...
<Tabs groupId="package-manager" items={['npm', 'yarn', 'pnpm', 'bun']} persist>
  <Tab value="npm">```bash npm install @reatom/core ```</Tab>
  <Tab value="yarn">```bash yarn add @reatom/core ```</Tab>
  <Tab value="pnpm">```bash pnpm add @reatom/core ```</Tab>
  <Tab value="bun">```bash bun add @reatom/core ```</Tab>
</Tabs>
...
<Tabs groupId="package-manager" items={['npm', 'yarn', 'pnpm', 'bun']} persist>
  <Tab value="npm">```bash npm install @reatom/npm-react ```</Tab>
  <Tab value="yarn">```bash yarn add @reatom/npm-react ```</Tab>
  <Tab value="pnpm">```bash pnpm add @reatom/npm-react ```</Tab>
  <Tab value="bun">```bash bun add @reatom/npm-react ```</Tab>
</Tabs>
